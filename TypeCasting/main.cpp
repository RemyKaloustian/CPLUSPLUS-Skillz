...
#pragma region STATIC
    ...
    //Dynamic is like: "Ok, I want to cast something but I want to be SURE that the result object is VALID, so throw an exception if the cast does not work, because we want VALID data.
    ...
    //a will BE printed, but with a, INVALID value
    showMessage("The dynamic cast from base object has a = ", cast_result->a);
